...
//	$body = mb_convert_encoding($body, "iso-2022-jp", "UTF-8");
	...
	$from = "Content-Type: text/html; charset=ISO-2022-JP\n"
		. "From:" . mb_encode_mimeheader( $from, "ISO-2022-JP-MS", "UTF-8" );
//	mail($toAddr, $subject, $body, $from , "-f" . EMAIL_HEAD);
	return mail($toAddr, $subject, $body, $from, "-f" . EMAIL_HEAD);
}
